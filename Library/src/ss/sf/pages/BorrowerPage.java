...
public class BorrowerPage {
	public static void checkCard(Scanner scanner) throws ClassNotFoundException, SQLException {
		
		System.out.println("Please enter library card number");
		...
		if (scannedLine.hasNextInt()) {
			...
			Borrower borrower = borDAO.getBorrowerByCardNumber(cardNumber).get(0);
	...
	public static void borr1(Scanner scanner,Borrower borrower) throws ClassNotFoundException, SQLException {
	...
	public static void checkOutBook(Scanner scanner,Borrower borrower) throws ClassNotFoundException, SQLException {
		...
		if (currentBranch != null) {
			...
			LocalDate dueDate =  dateOut.plus(2, ChronoUnit.WEEKS);
			bkDAO.checkOutBook(book.getBookId(),currentBranch.getBranchId(),borrower.getCardNo(),dateOut,dueDate);
	...
	public static void returnBooks(Scanner scanner,Borrower borrower) throws ClassNotFoundException, SQLException {
		...
		if (scannedLine.hasNextInt()) {
			int choice = scannedLine.nextInt();
			BookLoan chckedBk = bkLoans.get(choice-1);
